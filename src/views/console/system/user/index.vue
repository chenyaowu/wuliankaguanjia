<template>
  <div class="app-container">
    <el-form :inline="true" label-position="left" label-width="80px" :model="userForm">
      <el-row>
        <el-form-item label="用户名">
          <el-input v-model="userForm.username" />
        </el-form-item>
        <el-form-item label="用户类型">
          <el-select v-model="userForm.type" placeholder="用户类型">
    ...
    <platform-chooser :parent-platform-chooser-visible="platformChooserVisible" @doClosePlatformChooser="switchPlatformChooserVisible" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      getUser({ username: 'admin', password: '1111' }).then(response => {
